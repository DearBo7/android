...
import com.dan.expand.R;
import com.dan.expand.adapter.SimpleSpinnerTextFormatter;
import com.dan.expand.adapter.SpinnerTextFormatter;
import com.dan.expand.adapter.TextAdapter;
...
public class ViewMiddle<T> extends LinearLayout implements ViewBaseAction {
    ...
    public void setDataSource(Map<String, List<T>> groupMapValue) {
        ...
        regionListViewAdapter = new TextAdapter(context, groupList, R.drawable.choose_item_selected, R.drawable.item_etv_choose_ear_selector);
        ...
        regionListViewAdapter.setOnItemClickListener(new TextAdapter.OnItemClickListener() {
            @Override
        ...
        plateListViewAdapter = new TextAdapter(context, childrenItem, R.drawable.choose_item_right, R.drawable.item_etv_choose_plate_selector);
    ...
    public void setRegionAdapter(TextAdapter regionAdapter) {
        regionListView.setAdapter(regionAdapter);
    }

    public void setPlateAdapter(TextAdapter regionAdapter) {
