...
public class ItemView extends LinearLayout {
    ...
    public ItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        rootView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    listener.itemClick(rightDesc.getText() == null ? "" : rightDesc.getText().toString());
                }
            }
        });
    ...
    //设置左侧标题文字
    public void setLeftTitleText(String value) {
        leftTitle.setText(value);
    }

    //设置右侧描述文字
    public void setRightDescText(String value) {
     ...
     * 设置右侧箭头
     *
     * @param value [为null:隐藏不占用位置:不支持],true:显示,false:隐藏占用位置
     */
    public void setShowRightArrow(boolean value) {
        //value == null ? View.GONE : value ? View.VISIBLE : View.INVISIBLE
